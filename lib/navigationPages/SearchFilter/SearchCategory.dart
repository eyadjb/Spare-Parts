...
class FilteredAdsPage extends StatelessWidget {
  final String category;

  const FilteredAdsPage({required this.category, Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('מודעות לפי קטגוריה: $category'),
        centerTitle: true,
      ),
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(child: Text('No ads found for $category'));
          }
