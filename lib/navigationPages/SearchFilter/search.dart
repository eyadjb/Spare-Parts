...
class SearchParameters2 extends StatefulWidget {
  // final Function(Map<String, dynamic>) onSearch;

  // const SearchParameters2({required this.onSearch, Key? key}) : super(key: key);

  @override
  _SearchParametersState createState() => _SearchParametersState();
}

class _SearchParametersState extends State<SearchParameters2> {
          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                ...
                // backgroundColor:
                //     Color.fromARGB(255, 236, 3, 3).withOpacity(0.1),
